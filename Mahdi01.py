...
logo =                                          """            
\033[1;37m  _____         _   _        _    _        ____   ______     _______ 
 |  __ \       | \ | |      | |  | |      |  _ \ / __ \ \   / / ____|
...
def cutter():
    ...
    os.system('sort -r '+ssb+' | uniq > '+D-N-H )
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + D-N-H)
    print(47*'-')
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +D-N-H)
    os.system('sort -r '+ssb+' | uniq > '+D-N-H)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + D-N-H  )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
